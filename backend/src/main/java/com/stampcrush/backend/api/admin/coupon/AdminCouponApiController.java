package com.stampcrush.backend.api.admin.coupon;

import com.stampcrush.backend.api.OwnerAuth;
import com.stampcrush.backend.api.admin.coupon.request.CouponCreateRequest;
import com.stampcrush.backend.api.admin.coupon.request.StampCreateRequest;
import com.stampcrush.backend.api.admin.coupon.response.*;
