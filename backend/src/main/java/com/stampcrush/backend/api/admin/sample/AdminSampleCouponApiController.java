package com.stampcrush.backend.api.admin.sample;

import com.stampcrush.backend.api.OwnerAuth;
import com.stampcrush.backend.api.admin.sample.response.SampleCouponFindResponse;
...
public class AdminSampleCouponApiController {
