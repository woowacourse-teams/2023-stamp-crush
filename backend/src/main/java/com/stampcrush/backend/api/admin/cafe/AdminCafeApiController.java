package com.stampcrush.backend.api.admin.cafe;

import com.stampcrush.backend.api.OwnerAuth;
import com.stampcrush.backend.api.admin.cafe.request.CafeCreateRequest;
import com.stampcrush.backend.api.admin.cafe.request.CafeUpdateRequest;
import com.stampcrush.backend.api.admin.cafe.response.CafeFindResponse;
import com.stampcrush.backend.api.admin.cafe.response.CafesFindResponse;
...
public class AdminCafeApiController {
