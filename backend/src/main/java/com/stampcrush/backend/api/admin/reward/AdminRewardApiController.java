package com.stampcrush.backend.api.admin.reward;

import com.stampcrush.backend.api.OwnerAuth;
import com.stampcrush.backend.api.admin.reward.request.RewardFindRequest;
import com.stampcrush.backend.api.admin.reward.request.RewardUsedUpdateRequest;
import com.stampcrush.backend.api.admin.reward.response.RewardFindResponse;
import com.stampcrush.backend.api.admin.reward.response.RewardsFindResponse;
