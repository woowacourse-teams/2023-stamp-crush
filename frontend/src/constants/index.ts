...
export const ROUTER_PATH: Record<string, RouterPath> = {
  ...
  earnStamp: '/admin/enter-stamp/earn-stamp',
  selectCoupon: '/admin/enter-stamp/select-coupon',
  templateCouponDesign: '/admin/modify-coupon-policy/template-coupon-design',
  customCouponDesign: '/admin/modify-coupon-policy/custom-coupon-design',
  useReward: '/admin/enter-reward/use-reward',
  couponList: '/',
  login: '/login',
  signup: '/sign-up',
  myPage: '/my-page',
